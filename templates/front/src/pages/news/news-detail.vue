<template>
	...
	<div :style='{"width":"100%","margin":"0 auto"}'>
		<div :style='{"width":"100%","height":"auto"}'>
			<div :style='{"margin":"10px 0","fontSize":"24px","lineHeight":"54px","color":"#000","textAlign":"center","background":"#fff"}'>公告</div>
		</div>
		...
		<div class="news" :style='{"width":"100%","margin":"10px 0","background":"#fff","height":"auto"}'>
		  <div :style='{"padding":"0 20px","borderColor":"#75664D","color":"#75664D","borderWidth":"0 0 5px","width":"100%","lineHeight":"44px","fontSize":"24px","borderStyle":"solid"}'>推荐文章</div>
		  <div :style='{"width":"100%","padding":"20px 0","background":"#fff","display":"flex","height":"auto"}'>
		    <div v-for="item in recommendList" :key="item.id" :style='{"width":"23%","margin":"10px 1%","background":"#fff","height":"auto"}' @click="toDetail(item.id)">
		      <img :style='{"width":"100%","objectFit":"cover","borderRadius":"5px","display":"block","height":"150px"}' :src="baseUrl + item.picture" alt="">
