...
<div>
	<div :style='{"padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.1)","margin":"0px auto","borderColor":"#75664D","background":"#fff","borderWidth":"5px 0 0 0","width":"80%","borderStyle":"solid"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'>'" :style='{"fontSize":"14px","lineHeight":"1","justifyContent":"center","display":"flex"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/chengjitongzhi"><a>{{item.name}}</a></el-breadcrumb-item>
		...
		<div class="attr" :style='{"borderColor":"#75664d","margin":"10px 2%","background":"#fff","flex":"1","borderWidth":"5px 0 0","display":"flex","width":"45%","position":"relative","borderStyle":"solid","order":"1"}'>
			...
			<div class="info" :style='{"background":"#fff","flex":"1"}'>
				...
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>课程编号</div>
				...
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>成绩分数</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.chengjifenshu}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>发布时间</div>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#75664d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('chengjitongzhi','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#75664d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('chengjitongzhi','删除')" @click="delClick">删除</el-button>
					<!-- hasChat 无 -->
				</div>
			</div>
		</div>
  ...
  export default {
    ...
    methods: {
      ...
      nextClick(page) {
		...
		// 修改
		editClick(){
			this.$router.push(`/index/chengjitongzhiAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		delClick(){
			this.$confirm('是否删除此成绩通知？')
			  .then(_ => {
			    this.$http.post('chengjitongzhi/delete', [this.detail.id]).then(res => {
			      if (res.data.code == 0) {
			        this.$message({
			          type: 'success',
			          message: '删除成功!',
