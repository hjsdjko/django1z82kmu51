		...
		<div class="attr" :style='{"borderColor":"#75664d","margin":"10px 2%","background":"#fff","flex":"1","borderWidth":"5px 0 0","display":"flex","width":"45%","position":"relative","borderStyle":"solid","order":"1"}'>
			...
			<div class="info" :style='{"background":"#fff","flex":"1"}'>
				...
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>名称</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.name}}</div>
				</div>
				<div class="item" :style='{"padding":"5px 10px","boxShadow":"0 1px 0 #D8D8D8","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>url</div>
