...
import center from '@/views/center'
    ...
    import xuanzekecheng from '@/views/modules/xuanzekecheng/list'
    import chengjitongzhi from '@/views/modules/chengjitongzhi/list'
...
export const routes = [{
	...
	path: '/xuanzekecheng',
        name: '选择课程',
        component: xuanzekecheng
      }
      ,{
	path: '/chengjitongzhi',
        name: '成绩通知',
        component: chengjitongzhi
      }
      ,{
	path: '/banji',
        name: '班级',
