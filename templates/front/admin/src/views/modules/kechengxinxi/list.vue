<template>
	<div class="main-content" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#555","borderRadius":"0px","background":"rgba(255,255,255,1)","width":"100%","fontSize":"16px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('kechengxinxi','选择课程')" @click="xuanzekechengCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
		...
		<xuanzekecheng-cross-add-or-update v-if="xuanzekechengCrossAddOrUpdateFlag" :parent="this" ref="xuanzekechengCrossaddOrUpdate"></xuanzekecheng-cross-add-or-update>
...
import xuanzekechengCrossAddOrUpdate from "../xuanzekecheng/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				xuanzekechengCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			xuanzekechengCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.xuanzekechengCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.xuanzekechengCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.xuanzekechengCrossaddOrUpdate.init(row.id,type);
				});
			},
