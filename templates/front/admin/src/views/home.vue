...
<div class="content" :style='{"padding":"0px 30px 30px","margin":"0 auto","alignItems":"center","borderRadius":"0px","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230830/d58ecc944fb54dbfa18ecd2b64e92170.png) no-repeat center top / cover","display":"flex","width":"100%","fontSize":"14px","justifyContent":"center"}'>
	...
	<div :style='{"border":"0px solid #eee","padding":"0px","margin":"0 30px 30px 30px","alignItems":"flex-start","color":"#666","flexWrap":"wrap","background":"none","display":"flex","width":"240px","fontSize":"14px","justifyContent":"center","order":"2"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 10px 0","borderColor":"#eee","borderRadius":"0px","textAlign":"center","background":"rgba(255, 255, 255,.9)","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('xuesheng','首页总数')">
			...
			<div :style='{"width":"auto","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{xueshengCount}}</div>
